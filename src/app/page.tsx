            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <nav className="flex items-center justify-between">
                ...
                <div className="flex flex-row space-x-4">
                  {/* <a href="/login"> */}
                  <div className="rounded-md border border-transparent bg-bg3 px-4 py-2 text-md text-text transition duration-300 ease-in-out hover:bg-[#4f525a] select-none cursor-pointer">
                    <div className="flex items-center space-x-2">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5 fill-text">
